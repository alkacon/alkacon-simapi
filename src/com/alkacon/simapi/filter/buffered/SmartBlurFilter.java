...
public class SmartBlurFilter extends AbstractBufferedImageOp {
    ...
    public BufferedImage filter( BufferedImage src, BufferedImage dst ) {
        ...
        Kernel[] kernels = GaussianFilter.separatedKernels(hRadius);
        thresholdBlur( kernels[0], inPixels, outPixels, width, height, true );
        thresholdBlur( kernels[0], outPixels, inPixels, height, width, true );
